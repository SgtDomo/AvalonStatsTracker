...
namespace Avalon_Stats
{
    ...
    partial void DeleteGame(Game instance);
		...
		public DBClassesDataContext() : 
				base(global::Avalon_Stats.Properties.Settings.Default.avalon_statsConnectionString1, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class GameView : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.DateTime _gameEndDateTime;
    ...
    partial void OnKilledPlayerChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="gameEndDateTime", Storage="_gameEndDateTime", DbType="DateEndDateTime NOT NULL", CanBeNull=false)]
		public System.DateTime GameTime
		{
			get
			{
				return this._gameEndDateTime;
			}
			set
			{
				if ((this._gameEndDateTime != value))
				{
					this.OnGameTimeChanging(value);
					this.SendPropertyChanging();
					this._gameEndDateTime = value;
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_WonBy", DbType="Int")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="game_GameView", Storage="_game", ThisKey="GameId", OtherKey="GameId", IsForeignKey=true)]
		public Game Game
		{
			get
			{
    ...
    partial void OnKilledPlayerChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="game_GameView", Storage="_GameViews", ThisKey="GameId", OtherKey="GameId")]
		public EntitySet<GameView> GameViews
		{
			get
			{
